...
class READ_EXCELProcessor(Processor):
    TPL: str = '{"file_path":"", "file_path_key":"str on data_chain", "end_at":"10", "skip_first":"yes|no", "data_key":"name on data_chain"}'
    DESC: str = f''' 
    ...
    def process(self):
        ...
        data = ExcelUtil.get_data_from_excel_file(fp, 1 if skipFirst else 0, end_at)
