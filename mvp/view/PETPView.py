...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Sat Apr 18 11:48:40 2026
#
...
class PETPView(wx.Frame):
				def __init__(self, *args, **kwds):
								...
								self.e_left_panel.SetMinimumPaneSize(60)
								...
								self.e_right_panel.SetMinimumPaneSize(100)
								...
								input_editor_action_sizer.Add(self.cb_skipped, 0, wx.ALIGN_CENTER_VERTICAL, 0)
								...
								input_editor_handy_button = wx.BoxSizer(wx.HORIZONTAL)
								input_editor_sizer.Add(input_editor_handy_button, 0, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 0)

								self.convertRDir = wx.Button(self.input_editor_panel, wx.ID_ANY, "RDir")
								self.convertRDir.SetMinSize((40, 28))
								self.convertRDir.SetToolTip("get resources dir ")
								input_editor_handy_button.Add(self.convertRDir, 0, 0, 0)

								input_editor_handy_button.Add((5, 30), 0, 0, 0)

								self.convertDDir = wx.Button(self.input_editor_panel, wx.ID_ANY, "DDir")
								self.convertDDir.SetMinSize((40, 28))
								self.convertDDir.SetToolTip("get download dir ")
								input_editor_handy_button.Add(self.convertDDir, 0, 0, 0)

								input_editor_handy_button.Add((5, 30), 0, 0, 0)

								self.convertPWD = wx.Button(self.input_editor_panel, wx.ID_ANY, "E/D")
								self.convertPWD.SetMinSize((40, 28))
								self.convertPWD.SetToolTip("Prevent to save password into files")
								input_editor_handy_button.Add(self.convertPWD, 0, 0, 0)

								input_editor_handy_button.Add((5, 30), 0, 0, 0)

								self.convertGetData = wx.Button(self.input_editor_panel, wx.ID_ANY, "D")
								self.convertGetData.SetMinSize((40, 28))
								self.convertGetData.SetToolTip(u"{self.get_data(“var1”)} -> {var1}")
								input_editor_handy_button.Add(self.convertGetData, 0, 0, 0)

								input_editor_handy_button.Add((5, 30), 0, 0, 0)

								self.convertGetDeepData = wx.Button(self.input_editor_panel, wx.ID_ANY, "DD")
								self.convertGetDeepData.SetMinSize((40, 28))
								self.convertGetDeepData.SetToolTip("{self.get_deep_data([\"\",\"\"])}")
								input_editor_handy_button.Add(self.convertGetDeepData, 0, 0, 0)

								input_editor_handy_button.Add((5, 30), 0, 0, 0)

								self.appendDateStr = wx.Button(self.input_editor_panel, wx.ID_ANY, "DS")
								self.appendDateStr.SetMinSize((40, 28))
								self.appendDateStr.SetToolTip("{self.get_now_str()}")
								input_editor_handy_button.Add(self.appendDateStr, 0, 0, 0)

								input_editor_handy_button.Add((5, 30), 0, 0, 0)

								self.appendOsSep = wx.Button(self.input_editor_panel, wx.ID_ANY, "SEP")
								self.appendOsSep.SetMinSize((40, 28))
								self.appendOsSep.SetToolTip("{os.sep}")
								input_editor_handy_button.Add(self.appendOsSep, 0, 0, 0)
								...
								self.execution_desc = wx.TextCtrl(self.execution_desc_panel, wx.ID_ANY, "", style=wx.BORDER_NONE | wx.HSCROLL | wx.TE_DONTWRAP | wx.TE_LEFT | wx.TE_MULTILINE | wx.TE_PROCESS_ENTER)
								self.execution_desc.SetToolTip("Execution description")
								...
								actionPanelSizer_e.Add(self.langChooser, 0, 0, 0)
								...
								self.e_right_panel.SplitHorizontally(self.input_editor_panel, self.execution_desc_panel, 274)
								...
								self.splitterLR4E.SplitVertically(self.e_left_panel, self.e_right_panel, 1138)
