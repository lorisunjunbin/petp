...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Sat Apr 25 21:13:16 2026
#
...
class PETPView(wx.Frame):
				def __init__(self, *args, **kwds):
								...
								self.logSearchCtrl = wx.SearchCtrl(self.logPanel, wx.ID_ANY, "")
								self.logSearchCtrl.SetMinSize((220, -1))
								self.logSearchCtrl.ShowSearchButton(False)
								self.logSearchCtrl.ShowCancelButton(True)
								self.logSearchCtrl.SetDescriptiveText("Search")
								logSearchSizer.Add(self.logSearchCtrl, 0, wx.ALL, 2)

								self.previousOne = wx.Button(self.logPanel, wx.ID_ANY, "<")
								...
								logSearchSizer.Add(self.previousOne, 0, wx.ALL, 1)

								self.nextOne = wx.Button(self.logPanel, wx.ID_ANY, ">")
								...
								logSearchSizer.Add(self.nextOne, 0, wx.ALL, 1)
