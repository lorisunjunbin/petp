...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Fri May  1 22:40:21 2026
#
...
class PETPView(wx.Frame):
				def __init__(self, *args, **kwds):
								...
								choices=["Forest", "Ocean", "Monokai", "Solarized", "Nord", "Dracula", "Sakura", "Cyberpunk"]
								default="Forest"
								min_width=90
								self.themeChooser = PopupMenuButton(self.nbFirstPage, choices, default, min_width)
								actionPanelSizer_e.Add(self.themeChooser, 0, wx.EXPAND, 0)
								...
								default="EN"
								min_width=50
								self.langChooser = PopupMenuButton(self.nbFirstPage, choices, default, min_width)
								actionPanelSizer_e.Add(self.langChooser, 0, wx.EXPAND, 0)
