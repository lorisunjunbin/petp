...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Tue Jun  1 18:51:43 2021
#
...
class PETPView(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.testChooser.SetMinSize((120, 30))
        ...
        self.splitterLR4E = wx.SplitterWindow(self.nbFirstPage, wx.ID_ANY)
        ...
        self.taskProperty = wx.propgrid.PropertyGridManager(self.pgPanel, wx.ID_ANY, style=wx.propgrid.PG_BOLD_MODIFIED | wx.propgrid.PG_HIDE_MARGIN | wx.propgrid.PG_NO_INTERNAL_BORDER)
        pgSizer.Add(self.taskProperty, 1, wx.EXPAND, 0)

        self.pgaPanel = wx.Panel(self.pgPanel, wx.ID_ANY, style=wx.BORDER_NONE)
        self.pgaPanel.SetMinSize((-1, 30))
        pgSizer.Add(self.pgaPanel, 0, wx.BOTTOM | wx.EXPAND, 0)
        ...
        self.avaibleProperties.SetMinSize((120, 30))
        ...
        self.executionChooser.SetMinSize((300, 30))
        ...
        self.pipelineChooser.SetMinSize((300, 30))
        ...
        bpvSizer.Add(self.logContents, 1, wx.ALL | wx.EXPAND, 2)
        ...
        self.splitterLR4E.SplitVertically(self.taskGrid, self.pgPanel, 800)

        self.nbFirstPage.SetSizer(nbfpSizer)

        self.topPanel.SetSizer(tpSizer)

        self.splitterWindow.SplitHorizontally(self.topPanel, self.bottomPanel, 300)
