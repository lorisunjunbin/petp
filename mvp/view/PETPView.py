...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.4 on Sun Nov  6 15:28:44 2022
#
...
class PETPView(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        input_editor_action_sizer.Add(self.avaibleProperties, 0, wx.ALL, 1)
        ...
        self.e_left_panel.SplitHorizontally(self.task_editor, self.loop_editor, 240)

        self.splitterLR4E.SplitVertically(self.e_left_panel, self.e_right_panel, 840)

        self.nbFirstPage.SetSizer(e_main_Sizer)

        self.mainPanel.SetSizer(mainSizer)

        self.mainSplitterPanel.SplitHorizontally(self.mainPanel, self.logContents, 380)
