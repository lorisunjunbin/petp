...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Tue Apr 28 09:25:36 2026
#
...
class PETPView(wx.Frame):
				def __init__(self, *args, **kwds):
								...
								actionPanelSizer_e.Add(self.delExecution, 0, 0, 0)
								...
								actionPanelSizer_e.Add(self.copyExecution, 0, 0, 0)

								actionPanelSizer_e.Add((5, 30), 0, 0, 0)

								self.executionChooser = SearchableComboBox(self.nbFirstPage)
								self.executionChooser.SetMinSize((500, -1))
								actionPanelSizer_e.Add(self.executionChooser, 1, wx.EXPAND, 0)
								...
								self.themeChooser = wx.ComboBox(self.nbFirstPage, wx.ID_ANY, choices=["Forest", "Ocean", "Monokai", "Solarized"], style=wx.CB_DROPDOWN | wx.CB_READONLY | wx.TE_PROCESS_ENTER)
								self.themeChooser.SetMinSize((90, -1))
								self.themeChooser.SetToolTip("Change Language")
								actionPanelSizer_e.Add(self.themeChooser, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 0)

								actionPanelSizer_e.Add((5, 30), 0, 0, 0)

								self.langChooser = wx.ComboBox(self.nbFirstPage, wx.ID_ANY, choices=["EN", u"中文"], style=wx.CB_DROPDOWN | wx.CB_READONLY | wx.TE_PROCESS_ENTER)
								self.langChooser.SetMinSize((70, -1))
								self.langChooser.SetToolTip("Change Language")
								actionPanelSizer_e.Add(self.langChooser, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 0)

								actionPanelSizer_e.Add((5, 30), 0, 0, 0)

								self.logLevelChooser = wx.ComboBox(self.nbFirstPage, wx.ID_ANY, choices=["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL", "FATAL"], style=wx.CB_DROPDOWN | wx.CB_READONLY | wx.TE_PROCESS_ENTER)
								...
								self.pipelineChooser = SearchableComboBox(self.nbSecondPage)
								...
								self.logMatchCount = wx.StaticText(self.logPanel, wx.ID_ANY, "", style=wx.ALIGN_RIGHT)
								self.logMatchCount.SetMinSize((100, -1))
								self.logMatchCount.SetForegroundColour(wx.Colour(245, 222, 179))
								logSearchSizer.Add(self.logMatchCount, 0, wx.ALIGN_CENTER_VERTICAL, 0)

								logSearchSizer.Add((5, 20), 0, wx.EXPAND, 0)

								self.logSearchCtrl = wx.TextCtrl(self.logPanel, wx.ID_ANY, "", style=wx.BORDER_NONE | wx.TE_PROCESS_ENTER)
								self.logSearchCtrl.SetMinSize((220, -1))
								self.logSearchCtrl.SetBackgroundColour(wx.Colour(78, 78, 78))
								self.logSearchCtrl.SetForegroundColour(wx.Colour(245, 222, 179))
								logSearchSizer.Add(self.logSearchCtrl, 0, wx.ALIGN_CENTER_VERTICAL, 0)

								logSearchSizer.Add((5, 20), 0, wx.EXPAND, 0)

								self.previousOne = wx.Button(self.logPanel, wx.ID_ANY, "<", style=wx.BORDER_NONE)
								self.previousOne.SetMinSize((20, -1))
								self.previousOne.SetBackgroundColour(wx.Colour(78, 78, 78))
								self.previousOne.SetForegroundColour(wx.Colour(0, 255, 0))
								logSearchSizer.Add(self.previousOne, 0, wx.ALIGN_CENTER_VERTICAL, 0)

								self.nextOne = wx.Button(self.logPanel, wx.ID_ANY, ">", style=wx.BORDER_NONE)
								self.nextOne.SetMinSize((20, -1))
								self.nextOne.SetBackgroundColour(wx.Colour(78, 78, 78))
								self.nextOne.SetForegroundColour(wx.Colour(0, 255, 0))
								logSearchSizer.Add(self.nextOne, 0, wx.ALIGN_CENTER_VERTICAL, 0)
								...
								self.mainSplitterPanel.SplitHorizontally(self.mainPanel, self.logPanel, 400)
