...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Tue Apr 21 00:05:02 2026
#
...
class PETPView(wx.Frame):
				def __init__(self, *args, **kwds):
								...
								self.avaibleProperties = wx.ComboBox(self.input_editor_panel, wx.ID_ANY, choices=[], style=wx.CB_DROPDOWN | wx.TE_PROCESS_ENTER)
								...
								self.handy_tools = wx.Button(self.input_editor_panel, wx.ID_ANY, "Tools")
								self.handy_tools.SetMinSize((50, 28))
								self.handy_tools.SetToolTip("delete selected property")
