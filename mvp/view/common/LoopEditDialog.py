...
class LoopEditDialog(wx.Dialog):
    ...
    def __init__(self, parent, loop_code: str, loop_attributes_json: str):
        ...
        self._try_set_icon()
        self.Fit()
        self.SetMinSize(wx.Size(480, 300))
        self.CentreOnScreen()
    ...
    def _build_ui(self):
        ...
        for row, key in enumerate(self._keys):
            # key column — read-only, visually distinct
        ...
        # give value column the remaining width on resize
    ...
    def _on_ok(self, _evt):
        ...
        for row, key in enumerate(self._keys):
            ...
            # preserve numeric types if original was numeric
