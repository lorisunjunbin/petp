...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "menu_new_pipeline": {"en": "New Pipeline", "zh": "新建 Pipeline"},
    "menu_copy_pipeline": {"en": "Copy Pipeline", "zh": "复制 Pipeline"},
    "dlg_new_pipeline_name": {"en": "Enter pipeline name:", "zh": "输入 Pipeline 名称："},
    "dlg_new_pipeline_title": {"en": "New Pipeline", "zh": "新建 Pipeline"},
    "dlg_new_pipeline_dup": {"en": "Name is empty or already exists.", "zh": "名称为空或已存在。"},
    "dlg_copy_pipeline_name": {"en": "Enter new pipeline name:", "zh": "输入新 Pipeline 名称："},
    "dlg_copy_pipeline_title": {"en": "Copy Pipeline", "zh": "复制 Pipeline"},
    "tip_new_pipeline": {"en": "Create a new Pipeline", "zh": "新建 Pipeline"},
